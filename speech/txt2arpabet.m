...
aa = ismember(txtcell,{'aa' 'ah' 'a' 'bod' 'sop' 'sock' 'sod' 'shop' 'shock' 'shot' 'shawl' 'saw' 'car' 'gar' 'czar' 'cod' 'god' 'odd' 'copper' 'shopper' 'carbonate' 'llama'}); % added 'a' because this was the original vowel name for this category. Possibly will need to change it if we ever use the indefinite article.
...
eh = ismember(txtcell,{'eh' 'E' 'Ed' 'bed' 'bet' 'blend' 'dead' 'des' 'desk' 'debt' 'fed' 'head' 'ted' 'red' 'glen'  'hais' 'eff' 'fait' 'adept' 'meta' 'pet' 'sekt' 'set' 'said' 'shed' 'Ted' 'yellow' 'bedhead','pedestal','pedicure','pedigree', 'deficit', 'definite', 'seven' 'sever' 'level' 'headH' 'headL' 'headM' 'scent' 'sent' 'cent' 'pen' 'ten' 'hen' 'penitentiary'});
