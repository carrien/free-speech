...
aa = ismember(txtcell,{'aa', ...
    'ah' 'a' 'ba' 'bah' 'bod' 'boss' 'car' 'carbonate' 'cod' 'copper' 'czar' 'gar' 'god' 'llama', ...
    'odd' 'pa' 'saw' 'shawl' 'shock' 'shop' 'shopper' 'shot' 'sock' 'sod' 'sop'}); % added 'a' because this was the original vowel name for this category. Possibly will need to change it if we ever use the indefinite article.
