...
eh = ismember(txtcell,{'eh' 'E' 'Ed' 'bed' 'bet' 'blend' 'dead' 'des' 'desk' 'debt' 'fed' 'head' 'ted' 'red' 'glen'  'hais' 'eff' 'fait' 'adept' 'meta' 'pet' 'sekt' 'set' 'said' 'shed' 'Ted' 'yellow' 'bedhead','pedestal','pedicure','pedigree', 'deficit', 'definite', 'seven' 'sever' 'level' 'headH' 'headL' 'headM' 'scent' 'sent' 'cent' 'pen' 'ten' 'hen' 'penitentiary' 'pen a ten' 'pen_a_ten'});
