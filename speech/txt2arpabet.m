...
aa = ismember(txtcell,{'aa', ...
    'ah' 'a' 'ba' 'bah' 'bod' 'bot' 'boss' 'car' 'carbonate' 'cod' 'copper' 'czar' 'dock' 'gar' 'god' 'hod' , ...
    'llama' 'odd' 'pa' 'pot' 'saw' 'shawl' 'shock' 'shop' 'shopper' 'shot' 'sock' 'sod' 'sop' 'Tom' 'top'}); % added 'a' because this was the original vowel name for this category. Possibly will need to change it if we ever use the indefinite article.
ae = ismember(txtcell,{'ae',...
    'add', 'ad', 'bad', 'ban', 'bat', 'batA', 'batB', 'capper', 'cat', 'dad', 'gapper',...
    'had','pat', 'rad', 'sad', 'sapper', 'sat', 'tapper', 'yallow', 'zapper'});
ah = ismember(txtcell,{'ah', 'above', 'bud', 'bus' 'hud', 'tum'});
ay = ismember(txtcell,{'ay', 'bide', 'buy', 'buyYogurt', 'guide', 'idea', 'side', 'sigh', 'shy', 'thigh', 'time', 'thyme'});
eh = ismember(txtcell, {'eh', ... 
    'adept','bed','bedhead', 'bedspread', 'best','bet','blend', 'breastfed', 'cent','dead','debt','deficit','definite', ...
    'deathbed',  'den', 'des','desk','E','Ed','eff',...
    'fait','fed','glen','hais','head','headH','headL','headM', 'headrest', 'hen', 'level','meta',...
...
ih = ismember(txtcell,{'ih' 'I' 'bid' 'bin' 'bink' 'bit'  'rid' 'grin' 'yillow' 'pink' 'pit' 'sip' 'sin' 'sit' 'shin' 'ship' 'Tim' 'tipper' 'sipper' 'zipper' 'lion' 'hid'});
iy = ismember(txtcell,{'iy', ...
    'bead','bee','bleed','C','creed','deer', 'dear','deal','deem','ease','eat','ee','eep','Eve','green','heed','i','kreen','pea',...
...
uw = ismember(txtcell,{'uw' 'blue' 'booed' 'groom' 'oo' 'plume' 'plue' 'rude' 'sue' 'suit' 'soon' 'shoe' 'shoot' 'shoes' 'u' 'who''d'});
