...
aa = ismember(txtcell,{'aa' 'ah' 'a' 'ba' 'bah' 'bod' 'sop' 'sock' 'sod' 'shop' 'shock' 'shot' 'shawl' 'saw' 'car' 'gar' 'czar' 'cod' 'god' 'odd' 'copper' 'shopper' 'carbonate' 'llama' 'boss'}); % added 'a' because this was the original vowel name for this category. Possibly will need to change it if we ever use the indefinite article.
