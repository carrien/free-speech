...
iy = ismember(txtcell,{'iy', ...
    'bead','bean','bee','bleed','C','creed','deed','deer', 'dear','deal','deem','ease','eat','ee','eep','Eve','green','i','kreen','pea',...
...
ow = ismember(txtcell,{'ow' 'o' 'oh' 'blow' 'foam' 'bode' 'show' 'shore' 'so' 'sore'});
uw = ismember(txtcell,{'uw' 'blue' 'booed' 'boom' 'boon' 'dude' 'food' 'groom' 'oo' 'plume' 'plue' 'rude' 'sue' 'suit' 'soon' 'shoe' 'shoot' 'shoes' 'u'});
