function [observations,subjects,conditions,dist_init,dist_mid,durs,s_durs,c_durs,observations_mean,conditions_mean] = plot_centering_crossSubj(exptName,subdir,svec,ntile)
...
for s=1:length(svec)
    load(fullfile(getAcoustSubjPath(exptName,svec(s),subdir),sprintf('centering_%dtile.mat',ntile)));
