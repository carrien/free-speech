...
instruct.moveintro={'During Speaking/Listening task, remember to' '' 'stay as still as possible ' '' 'and minimize your head and jaw movement' };
instruct.restintro={'You will be given short or long break when finish each session.'};% '' 'Press the space bar to continue.'
instruct.starttxt_speaking={'Get ready to SPEAK.' '' 'Stay still, keep your eyes open and look at the screen .' };
instruct.starttxt_listening={'Get ready to LISTEN.' '' 'Stay still, keep your eyes open and look at the screen.'};
