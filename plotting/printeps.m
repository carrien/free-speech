...
figfilestr = [figname '_epsc2.eps'];
figfilestr_c = [figname '_epsc.eps'];
figfilestr_cs = [figname '_epsc_saveas.eps'];
eval(['print -depsc2 -f' num2str(fignum) ' ' figfilestr ';']);
print(fignum, '-depsc', figfilestr_c);
saveas(fignum,figfilestr_cs,'epsc');
