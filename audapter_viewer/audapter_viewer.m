...
hf = figure('Name',p.plot_params.name,'Units','normalized','Position',p.plot_params.figpos, 'Color', bgColor_fig, 'CloseRequestFcn', @save_exit);
...
buttonFontSize = .4; % in normalized units
...
htext.statusParam1Unit = uicontrol(p.guidata.buttonPanel, 'Style','text',...
    'String',heurUnits{1},...
    'BackgroundColor', p.guidata.buttonPanel.BackgroundColor, ...
...
htext.trialLabel = uicontrol(p.guidata.trialPanel,'Style','text',...
    'String', sprintf('Jump to\ntrials...'),'FontWeight','Bold',...
    'BackgroundColor', p.guidata.trialPanel.BackgroundColor, ...
...
htext.durHold = uicontrol(p.guidata.pcf_buttonPanel, 'Style','text',...
    'String','durHold',...
    'BackgroundColor', p.guidata.pcf_buttonPanel.BackgroundColor, ...
